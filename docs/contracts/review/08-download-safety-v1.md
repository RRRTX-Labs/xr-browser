# Review packet: xr.mojom.DownloadSafety: Scan/Verdict v1 (§1.11)

- **Contract id:** download-safety  **Version:** 1  **Freeze status:** REVIEW-COMPLETE
- **Ratification:** PENDING (HG-26; human sign-off below is pending)

## Interface inventory
deny-default (unknown=>held); direct-media affordance flag (§2.6).
...
xr-core/mojom/downloads.mojom, fakes/downloads.py
...
- [ ] fuzz target required before integration — target: `fuzz_download_safety` (P9; declaration only) — sign-off: __PENDING (human)__
