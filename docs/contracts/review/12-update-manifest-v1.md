# Review packet: Update manifest (Omaha 3.1 subset) v1 (§1.11)

- **Contract id:** update-manifest  **Version:** 1  **Freeze status:** REVIEW-COMPLETE
- **Ratification:** PENDING (HG-26; human sign-off below is pending)

## Interface inventory
conformance cited file:line@pin; client acceptance PENDING-VERIFY-farm.
...
update-manifest-31-json.md, update-manifest-31.schema.json
...
- [ ] fuzz target required before integration — target: `fuzz_update_manifest` (P9; declaration only) — sign-off: __PENDING (human)__
