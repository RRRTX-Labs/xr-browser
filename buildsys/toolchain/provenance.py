"""buildsys/toolchain/provenance.py — record + verify toolchain digests (R0).
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="buildsys/toolchain/provenance.py",
    ...
    parser.add_argument("--pins", default="buildsys/toolchain/pins.json", help="pins.json path (repo-relative)")
