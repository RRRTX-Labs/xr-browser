"""buildsys/sbom/sbom_gate.py — validate an SBOM against the vendored schema (stdlib).
...
we stay stdlib). Reference schema: buildsys/sbom/cyclonedx-schema-1.6.json.
"""
...
SCHEMA = "buildsys/sbom/cyclonedx-schema-1.6.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="buildsys/sbom/sbom_gate.py",
