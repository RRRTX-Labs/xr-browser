"""buildsys/gn/resolve_args.py — merge + validate the XR GN argsets.
...
# Locate buildsys/_common.py regardless of invocation dir (walk up to it).
...
ARGSETS_DIR = "buildsys/gn/argsets"
...
def cmd_resolve(args: argparse.Namespace) -> int:
    ...
    lines = [
        "# Generated by buildsys/gn/resolve_args.py — do not edit by hand.",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="buildsys/gn/resolve_args.py",
