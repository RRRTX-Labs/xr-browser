...
xr_core_rev: "537d0f76085450693c12ed3dbc9a5f8ab57d79d4"     # xr-core P12-T1/T2/T3/T4/T5 + the blink_seams patch: renderer/cosmetic complete + cosmetic.mojom (ninth interface) + test_cosmetic_fuzz.cc — 7 core modules, abpf validator, scriptlet registry, cosmetic_host (8 methods) + host_protocol.md, fakes/cosmetic.py as an 8-method parity reference, 200 golden vectors byte-identical across both backends; patches/blink-seams/0300-cosmetic-document-start (5 files, Document::WillInsertBody, generated by build/webui/cosmetic_seam_roundtrip.py from these bytes). 1433 C++ checks, mutation 418/418. NOT compiled — gn/ninja absent; no Chromium build claimed.
