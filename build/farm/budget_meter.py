"""build/farm/budget_meter.py — the patch-budget meter (Plan P2-T10).
...
`xr-patch lint` (build/patching/apply.py) — see docs/contracts/patch-manifest-v1.md.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="build/farm/budget_meter.py",
