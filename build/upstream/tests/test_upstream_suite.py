...
# corpus_setup lives in conftest.py (P11-T0-e split: the added-file T0
# canaries moved to test_upstream_t0_added_files.py and both modules use it).
...
# ---------------------------------------------------------------------------
# T0 — added-file semantics (P8 blocking debt) MOVED to
# test_upstream_t0_added_files.py by the P11-T0-e touched-file size law
# (<=380 lines): the added-file canary family is its own responsibility.
# Nothing was renamed, reordered or weakened — the tests are byte-identical.
# ---------------------------------------------------------------------------
