...
**Rule:** after `./scripts/build sync`, build time performs **no fetches**. This is a
...
`build/sync.py` writes `<checkout>/.xr/egress.json` — an egress manifest:
