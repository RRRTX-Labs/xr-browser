...
NEG_FILES=(p1_p2.sh p3_p4.sh p5_p6.sh p7_p8.sh p9_core.sh p9_ci.sh p10_release.sh p11_t0.sh p11_t0d.sh p11_t0e.sh p11_t1.sh p11_t2.sh p11_t3.sh p11_t4.sh p11_t5.sh p11_t6.sh)
